...
export class ModularCommands {
     ...
     */
    private async injectCommand(command: string, description: string) {
 ...
 */
export function registerModularCommands(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.quickFix', 
            () => modularCommands.quickFix())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.deploySpecialist',
            () => modularCommands.deploySpecialist())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.codeReview',
            () => modularCommands.codeReview())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.generateTests',
            () => modularCommands.generateTests())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.executeSingleWave',
            () => modularCommands.executeSingleWave())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.createDocumentation',
            () => modularCommands.createDocumentation())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.architectureConsult',
            () => modularCommands.architectureConsult())
    );
    
    context.subscriptions.push(
        vscode.commands.registerCommand('shadowClone.showCommands',
            () => modularCommands.showCommands())
    );
}