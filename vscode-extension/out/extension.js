...
const modularCommands_1 = require("./commands/modularCommands");
...
const checkDependencies_1 = require("./commands/checkDependencies");
let authProvider;
let sessionManager;
...
async function activate(context) {
    ...
    try {
        ...
        const dependencyChecker = dependencyChecker_1.DependencyChecker.getInstance();
        ...
        if (!depStatus.nodeInstalled || !depStatus.claudeInstalled) {
            const choice = await vscode.window.showWarningMessage('Shadow Clone requires Node.js and Claude Code CLI to function properly.', 'Setup Now', 'Later');
            if (choice === 'Setup Now') {
                await (0, checkDependencies_1.checkDependencies)(context);
            }
        }
        // Initialize API key cache
        const { ApiKeyCache } = await Promise.resolve().then(() => __importStar(require('./utils/apiKeyCache')));
        ...
        }), vscode.commands.registerCommand('shadowClone.showStatus', () => (0, showStatus_1.showStatusCommand)(authProvider, licenseStatusManager)), 
        // Dependency management command
        vscode.commands.registerCommand('shadowClone.checkDependencies', () => (0, checkDependencies_1.checkDependencies)(context)), 
        // Claude integration commands
        vscode.commands.registerCommand('shadowClone.launchClaude', (0, authGuard_1.withAuthSync)(() => (0, claudeLauncher_1.launchClaudeCommand)(sessionManager, authProvider), authProvider, {
            requireActiveSubscription: true
        })), vscode.commands.registerCommand('shadowClone.launchClaudeQuick', (0, authGuard_1.withAuthSync)((args) => (0, claudeLauncher_1.launchClaudeWithArgumentsCommand)(sessionManager, authProvider, args), authProvider, {
            requireActiveSubscription: true
        })), vscode.commands.registerCommand('shadowClone.showSessions', (0, authGuard_1.withAuthSync)(() => {
            vscode.commands.executeCommand('shadowClone.claudeSessions.focus');
        }, authProvider)), vscode.commands.registerCommand('shadowClone.openSessionOutput', (0, authGuard_1.withAuthSync)((sessionId) => {
            const session = sessionManager.getSession(sessionId);
            if (session?.outputPath) {
                vscode.commands.executeCommand('vscode.open', vscode.Uri.file(session.outputPath));
            }
        }, authProvider)), vscode.commands.registerCommand('shadowClone.terminateSession', (0, authGuard_1.withAuthSync)((sessionId) => {
            sessionManager.terminateSession(sessionId);
        }, authProvider)), vscode.commands.registerCommand('shadowClone.clearCompletedSessions', (0, authGuard_1.withAuthSync)(() => {
            sessionManager.clearCompletedSessions();
        }, authProvider)), vscode.commands.registerCommand('shadowClone.copyCommand', (0, authGuard_1.withAuthSync)((command) => {
            vscode.env.clipboard.writeText(command);
            vscode.window.showInformationMessage('Shadow Clone command copied to clipboard!');
        }, authProvider)), vscode.commands.registerCommand('shadowClone.buildCustomCommand', (0, authGuard_1.withAuth)(async () => {
        ...
        vscode.commands.registerCommand('shadowClone.injectCommand', () => (0, injectCommand_1.injectShadowCloneCommand)(authProvider)), vscode.commands.registerCommand('shadowClone.injectBuild', () => (0, injectCommand_1.injectBuildCommand)(authProvider)), vscode.commands.registerCommand('shadowClone.injectDebug', () => (0, injectCommand_1.injectDebugCommand)(authProvider)), vscode.commands.registerCommand('shadowClone.injectFeature', () => (0, injectCommand_1.injectFeatureCommand)(authProvider)), vscode.commands.registerCommand('shadowClone.executeMacro', (commandType) => (0, injectCommand_1.injectShadowCloneCommand)(authProvider, commandType)), 
        // Help commands
        ...
        // Parameter commands
        vscode.commands.registerCommand('shadowClone.buildParameters', (0, authGuard_1.withAuthSync)(() => (0, parameterBuilder_1.injectParametersCommand)(), authProvider)), vscode.commands.registerCommand('shadowClone.paramSnippet.minimal', () => (0, parameterBuilder_1.injectParameterSnippet)('MINIMAL')), vscode.commands.registerCommand('shadowClone.paramSnippet.standard', () => (0, parameterBuilder_1.injectParameterSnippet)('STANDARD')), vscode.commands.registerCommand('shadowClone.paramSnippet.fullstack', () => (0, parameterBuilder_1.injectParameterSnippet)('FULL_STACK')), 
        // Session management commands
        vscode.commands.registerCommand('shadowClone.registerTerminal', (0, authGuard_1.withAuthSync)(() => {
            terminalMonitor.registerCurrentTerminal();
        }, authProvider)), vscode.commands.registerCommand('shadowClone.showSessionPicker', (0, authGuard_1.withAuthSync)(() => {
        ...
        (0, modularCommands_1.registerModularCommands)(context, authProvider);
        // Initial update
