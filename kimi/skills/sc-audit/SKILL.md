...
type: prompt
whenToUse: When the user asks to run a Shadow Clone audit, security/quality assessment, compliance review, or a security checklist scan
---
