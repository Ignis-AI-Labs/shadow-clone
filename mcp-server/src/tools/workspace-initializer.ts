    ...
    try {
      ...
      if (includeTypes.includes('claude')) {
        ...
        if (existingClaude === null) {
          await this.writeNoFollow(claudePath, CLAUDE_INSTRUCTIONS);
      ...
      if (includeTypes.includes('general')) {
        ...
        await this.writeNoFollow(aiPath, AI_INSTRUCTIONS);
      ...
      if (includeTypes.includes('github')) {
        ...
        await this.writeNoFollow(copilotPath, COPILOT_INSTRUCTIONS);
      ...
      if (includeTypes.includes('vscode')) {
        ...
        await this.writeNoFollow(vscodePath, VSCODE_INSTRUCTIONS);
