...
describe('HTTP Schema Validation', () => {
  ...
  describe('erc712AuthMessageSchema', () => {
    test('accepts valid auth message', () => {
      const result = erc712AuthMessageSchema.safeParse({
        wallet: validAddress,
        nonce: 'abc123',
        deadline: futureDeadline
      });
  ...
  describe('authRequestSchema', () => {
    test('accepts valid auth request', () => {
  ...
  describe('walletAuthRequestSchema', () => {
    test('accepts valid wallet auth request', () => {
      const result = walletAuthRequestSchema.safeParse({
        message: {
          wallet: validAddress,
          nonce: 'abc123',
          deadline: futureDeadline
    ...
    test('rejects invalid message wallet address', () => {
      const result = walletAuthRequestSchema.safeParse({
        message: {
          wallet: 'invalid',
          nonce: 'abc123',
